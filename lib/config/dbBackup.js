        ...
        var j = schedule.scheduleJob('* * 4 * * *', function(){
            mysqldump({
                connection: {
                    ...
                    database: 'ln_vegetable',
                },
                dumpToFile: './dbBackup/ln_vegetable'+moment(new Date()).format("YYYY-MM-DD")+'.sql',
            });
          });
          ...
          var i = schedule.scheduleJob('1 30 5 * * *', function(){
            ...
            const mailOptions = {
                ...
                subject: "DB_BCK", // Subject line
                html: "", // plain text body
                attachments:[
                    {
                        path: './dbBackup/ln_vegetable'+moment(new Date()).format("YYYY-MM-DD")+'.sql'
                    }
                ]
            };
