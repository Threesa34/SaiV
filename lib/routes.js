...
module.exports = {
	...
	configure: function (app) {
		...
		app.get('/api/deletePurchaseOrder/:id', function (req, res) {
			security(req, res);
			order.deletePurchaseOrder(req, res);
		});
		...
		app.post('/api/SaveVendorPaymentCollection', function (req, res) {
			security(req, res);
			order.SaveVendorPaymentCollection(req, res);
		});
		...
		app.post('/api/getVendorPaymentReport/', function (req, res) {
			security(req, res);
			reports.getVendorPaymentReport(req, res);
		});
		...
		app.post('/api/getVendorsPendingPaymentsData/', function (req, res) {
			security(req, res);
			reports.getVendorsPendingPaymentsData(req, res);
		});

		app.post('/api/getPurchasedItemsList/', function (req, res) {
			security(req, res);
			reports.getPurchasedItemsList(req, res);
		});
...
// VENDOR
		...
		app.post('/api/getAllInvoicesCopies', function (req, res) {
			security(req, res);
			order.getAllInvoicesCopies(req, res);
		});
